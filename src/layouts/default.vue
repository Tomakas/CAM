<template>
  <v-app-bar app>
    ...
    <v-menu location="bottom end" transition="scale-transition">
      ...
      <v-list>
        <v-list-item :to="'/account'" :prepend-icon="'mdi-account-cog'" :title="userName"></v-list-item>
        <v-divider></v-divider>
...
// Inicializace t pro překlady
const { t } = useI18n();

// Získání refů z Pinia store, včetně userName
const { navInAppBar, navWithText, userName } = storeToRefs(appStore); // <-- ZMĚNA ZDE
