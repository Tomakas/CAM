  ...
  <v-container fluid>
    <v-card class="mx-auto" flat>
      ...
      <ReuseTable v-if="activePanel" :headers="activePanel.headers" :items="activePanel.items" :search="searchText" :loading="loading"
        v-model:page="currentPage" v-model:items-per-page="itemsPerPage" :total-items="totalItems" v-model:sort-by="sortBy"
        v-model:sort-desc="sortDesc" :highlight-text="searchText" />
